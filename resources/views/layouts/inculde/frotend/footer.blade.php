        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2"><a href="{{ url('/arrivals') }}" class="text-white">New Arrivals Products</a>
                    </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2">
                        <a href="" class="text-white">
                            <i class="fa fa-envelope"></i> {{ $appSetting->email_1 }}
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="social-media">
                        Get Connected:
                        @if ($appSetting->facbook)
                            <a href="{{ $appSetting->facbook }}" target="_blank"><i class="fa fa-facebook"></i></a>
                        @endif
